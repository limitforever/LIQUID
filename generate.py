...
from transformers import AutoModel,AutoTokenizer, AutoModelForQuestionAnswering, AutoModelForSeq2SeqLM
...
def main(args):
    ...
    s.keep_alive = False
    # question generation
    # qgmodeltemp = AutoModel.from_pretrained(args.qg_model_name_or_path)
    # qg_tokenizer = AutoTokenizer.from_pretrained(qgmodeltemp)
    ...
    s.keep_alive = False
    # iterative filtering
    qa_model_name_or_path = './thatdramebaazguy'
    # qa_model_name = AutoModel.from_pretrained(qa_model_name_or_path)
    qa_tokenizer = AutoTokenizer.from_pretrained(qa_model_name_or_path)

    # qa_tokenizer = AutoTokenizer.from_pretrained(args.qa_model_name_or_path)
    qa_model = AutoModelForQuestionAnswering.from_pretrained(qa_model_name_or_path)
